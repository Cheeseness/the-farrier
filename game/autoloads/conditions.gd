...
const splinter_scene = preload("res://game/conditions/splinter/splinter.tscn")
const bruise_a_scene = preload("res://game/conditions/bruise/bruise_a.tscn")
const bruise_b_scene = preload("res://game/conditions/bruise/bruise_b.tscn")
